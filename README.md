...
[![Tests](https://img.shields.io/badge/tests-320%20passing-brightgreen)](tests/unit)
...
320 unit tests cover the security-critical paths; ruff and mypy are blocking in CI
...
```bash
uv run pytest tests/unit/ -v     # 320 tests
