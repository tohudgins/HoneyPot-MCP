...
[![Tests](https://img.shields.io/badge/tests-779%20unit%20%2B%206%20e2e-brightgreen)](tests/)
...
779 unit tests plus 6 end-to-end pipeline tests cover the security-critical paths; ruff and mypy are blocking in CI
...
```bash
uv run pytest tests/unit/ -v     # 779 unit tests
